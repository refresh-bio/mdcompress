...
// *****************************************************************
std::vector<uint8_t>& Serializer::get_data()
{
	return data;
}

// *****************************************************************
void Serializer::set_data(const std::vector<uint8_t>& _data)
{
	data = _data;
...
// *****************************************************************
void Serializer::set_data(std::vector<uint8_t>&& _data)
{
	data = std::move(_data);
...
// *****************************************************************
void Serializer::append32f(float x)
{
	append32u(std::bit_cast<uint32_t, float>(x));
}

// *****************************************************************
void Serializer::append64f(double x)
{
	append64u(std::bit_cast<uint64_t, double>(x));
}

// *****************************************************************
void Serializer::append16u(uint16_t x)
{
	data.push_back(x >> 8);
	data.push_back(x & 0xffu);
}
...
// *****************************************************************
void Serializer::append_str(const std::string& str)
{
...
// *****************************************************************
double Serializer::load64f()
{
	return std::bit_cast<double, uint64_t>(load64u());
}
...
// *****************************************************************
float Serializer::load32f()
{
	return std::bit_cast<float, uint32_t>(load32u());
}

// *****************************************************************
uint16_t Serializer::load16u()
{
	uint16_t r = *iter++;
	r <<= 8;
	r += *iter++;
...
// *****************************************************************
std::string Serializer::load_str()
{
	auto p = iter;
...
// *****************************************************************
void Serializer::append_vec_str(const std::vector<std::string>& vs)
{
	for (const auto& x : vs)
		append_str(x);
}
...
// *****************************************************************
void Serializer::load_vec_str(std::vector<std::string>& vs, size_t n_items)
{
	vs.resize(n_items);
...
void Serializer::load_serializer(Serializer& ser)
{
	...
	std::vector<uint8_t> ser_data(ser_size);
